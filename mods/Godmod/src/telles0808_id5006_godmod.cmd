...
title Build and Deploy - telles0808_id5006_godmod
echo ========================================================
echo   Compilando e Implantando: telles0808_id5006_godmod
echo ========================================================
...
echo.
echo ========================================================
echo telles0808_id5006_godmod compilado, implantado e cache limpo!
echo ========================================================
echo.
pause
goto :EOF
...
$ModName = 'Godmod'
$ModId = 5006
$ModKey = 'telles0808_id5006_godmod'
$ModFileName = 'telles0808_id5006_godmod.mod'
$gmlFileName = $ModKey + ".gml"
$rootDir = Split-Path -Parent $scriptDir
$srcFile = Join-Path $scriptDir $gmlFileName
$targetDir = Join-Path $rootDir '00 - Godmod'
...
$infoJson = @"
{
	...
	"author" : "Telles0808",
	"version" : "1.0.0",
	"description" : "$ModName mod for Tinkerlands - Infinite HP, MP, SP & Dashes toggle (F9)"
}
"@
...
if ($steamMods -and (Test-Path $steamMods)) {
    Get-ChildItem -Path $steamMods -Filter "*godmod*.mod" | Where-Object { $_.Name -ne $ModFileName } | Remove-Item -Force -ErrorAction SilentlyContinue
