...
title Build and Deploy - telles0808_id5003_bo
echo ========================================================
echo   Compilando e Implantando: telles0808_id5003_bo (BO)
echo ========================================================
...
echo.
echo ========================================================
echo telles0808_id5003_bo compilado, implantado e cache limpo!
echo ========================================================
echo.
pause
goto :EOF
...
$ModName = 'BO'
$ModId = 5003
$ModKey = 'telles0808_id5003_bo'
$ModFileName = 'telles0808_id5003_bo.mod'
$gmlFileName = 'telles0808_id5003_bo.gml'
$rootDir = Split-Path -Parent $scriptDir
$srcFile = Join-Path $scriptDir $gmlFileName
$targetDir = Join-Path $rootDir '00 - BO'
...
if ($steamMods -and (Test-Path $steamMods)) {
    Get-ChildItem -Path $steamMods -Filter "*bo*.mod" | Where-Object { $_.Name -ne $ModFileName } | Remove-Item -Force -ErrorAction SilentlyContinue
    Get-ChildItem -Path $steamMods -Filter "BO.mod" | Remove-Item -Force -ErrorAction SilentlyContinue
